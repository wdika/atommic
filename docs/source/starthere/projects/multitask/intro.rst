...
The following publicly available datasets are natively supported within atommic for MTL.
...
In MTL reconstruction & segmentation, the segmentation task can be performed either in an multiclass or a multilabel manner.
