...
class MRISegmentationLambdaUNet(BaseMRISegmentationNet):
...
class CTSegmentationLambdaUNet(BaseCTSegmentationNet):
    """Implementation of the Lambda UNet for CT segmentation, as presented in [Yanglan2021]_.
...
class SegmentationLambdaUNet:
    """Factory class for the Lambda UNet segmentation network, as presented in [Yanglan2021]_.
    ...
    def get_model(cfg: DictConfig, trainer: Trainer = None):
        ...
        if modality == "mri":
            return MRISegmentationLambdaUNet(cfg)
        elif modality == "ct":
            return CTSegmentationLambdaUNet(cfg)
        else:
